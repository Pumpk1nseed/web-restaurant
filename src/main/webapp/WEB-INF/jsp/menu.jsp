...
<div class="topline">
    <table>
        <tr>
            ...
            <td><h1>${menu_link}</h1></td>
        </tr>
    </table>
</div>
<div class="account"><a href="jspaccount"><span>${account_link}</span></a></div>
        ...
        <table>
            ...
            <tr id="orderRow">
                <c:forEach items="${menu.getDishes()}" var="dish">
                    <c:if test="${dish.idCategory == category.idCategory}">
                        <td>
                            <button onclick="reduceOne(event, `${category.idCategory}`, `${dish.idDish}`)">-</button>
