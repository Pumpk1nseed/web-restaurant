...
public class ValidationParameter {
    ...
    public static final String VALIDATION_REGEX_TELEPHONE = "validation.regex.telephone";
    public static final String VALIDATION_REGEX_EMAIL = "validation.regex.email";
    ...
    public static final String VALIDATION_ERRORMSG_ID = "validation.errormsg.id";
